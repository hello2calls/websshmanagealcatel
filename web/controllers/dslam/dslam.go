...
func Get(w http.ResponseWriter, r *http.Request, dataFile S.Data) {
	...
	if r.URL.RawQuery != "" {
		...
		OptionList += "<div class=\"pure-control-group\"><label for=\"internetVlan\">VLAN</label><input id=\"internetVlan\" name=\"internetVlan\" style=\"width:80px\" type=\"number\" max=\"4094\" placeholder=\"VLAN\" value=" + dataFile.DSLAM[dslamPos].Internet.Vlan + ">"
		OptionList += "<label style=\"width:auto; margin-left:20px\" for=\"internetVpi\">VPI</label><input id=\"internetVpi\" name=\"internetVpi\" style=\"width:80px\" type=\"number\" max=\"255\" placeholder=\"VPI\" value=" + dataFile.DSLAM[dslamPos].Internet.Vpi + ">"
		OptionList += "<label style=\"width:auto; margin-left:20px\" for=\"internetVci\">VCI</label><input id=\"internetVci\" name=\"internetVci\" style=\"width:80px\" type=\"number\" max=\"65535\" placeholder=\"VCI\" value=" + dataFile.DSLAM[dslamPos].Internet.Vci + "></div>"
		OptionList += "<br><div class=\"pure-control-group\"><label>Téléphonie</label></div>"
		OptionList += "<div class=\"pure-control-group\"><label for=\"voipVlan\">VLAN</label><input id=\"voipVlan\" name=\"voipVlan\" style=\"width:80px\" type=\"number\" max=\"4094\" placeholder=\"VLAN\" value=" + dataFile.DSLAM[dslamPos].Telephony.Vlan + ">"
		OptionList += "<label style=\"width:auto; margin-left:20px\" for=\"voipVpi\">VPI</label><input id=\"voipVpi\" name=\"voipVpi\" style=\"width:80px\" type=\"number\" max=\"255\" placeholder=\"VPI\" value=" + dataFile.DSLAM[dslamPos].Telephony.Vpi + ">"
		OptionList += "<label style=\"width:auto; margin-left:20px\" for=\"voipVci\">VCI</label><input id=\"voipVci\" name=\"voipVci\" style=\"width:80px\" type=\"number\" max=\"65535\" placeholder=\"VCI\" value=" + dataFile.DSLAM[dslamPos].Telephony.Vci + "></div>"
		OptionList += "<br><div class=\"pure-control-group\"><label>Vidéo</label></div>"
		OptionList += "<div class=\"pure-control-group\"><label for=\"videoVlan\">VLAN</label><input id=\"videoVlan\" name=\"videoVlan\" style=\"width:80px\" type=\"number\" max=\"4094\" placeholder=\"VLAN\" value=" + dataFile.DSLAM[dslamPos].Video.Vlan + ">"
		OptionList += "<label style=\"width:auto; margin-left:20px\" for=\"videoVpi\">VPI</label><input id=\"videoVpi\" name=\"videoVpi\" style=\"width:80px\" type=\"number\" max=\"255\" placeholder=\"VPI\" value=" + dataFile.DSLAM[dslamPos].Video.Vpi + ">"
		OptionList += "<label style=\"width:auto; margin-left:20px\" for=\"videoVci\">VCI</label><input id=\"videoVci\" name=\"videoVci\" style=\"width:80px\" type=\"number\" max=\"65535\" placeholder=\"VCI\" value=" + dataFile.DSLAM[dslamPos].Video.Vci + "></div>"
		OptionList += "<input type=\"hidden\" name=\"id\" id=\"id\" value=" + dataFile.DSLAM[dslamPos].ID + ">"
		OptionList += "<div class=\"pure-control-group pure-u-1 pure-u-sm-1-2\"><label></label><button type=\"submit\" class=\"pure-button-primary pure-button\">Envoyer</button></div>"
		OptionList += "<div class=\"pure-control-group pure-u-1 pure-u-sm-1-2\"><label style=\"margin-right:0px\"></label><button onclick=\"sendDelete()\" class=\"button-error pure-button\">Supprimer</button></div>"
