...
func Get(w http.ResponseWriter, r *http.Request, dataFile S.Data) {
	...
	case "add":
		...
		Options += "<div class=\"pure-control-group\"><label for=\"internetVlan\">VLAN</label><input id=\"internetVlan\" name=\"internetVlan\" style=\"width:100px\" type=\"number\" max=\"4094\" placeholder=\"VLAN\">"
		Options += "<label style=\"width:auto; margin-left:20px\" for=\"internetVpi\">VPI</label><input id=\"internetVpi\" name=\"internetVpi\" style=\"width:100px\" type=\"number\" max=\"255\" placeholder=\"VPI\">"
		Options += "<label style=\"width:auto; margin-left:20px\" for=\"internetVci\">VCI</label><input id=\"internetVci\" name=\"internetVci\" style=\"width:100px\" type=\"number\" max=\"65535\" placeholder=\"VCI\"></div>"
		Options += "<br><div class=\"pure-control-group\"><label>Téléphonie</label></div>"
		Options += "<div class=\"pure-control-group\"><label for=\"voipVlan\">VLAN</label><input id=\"voipVlan\" name=\"voipVlan\" style=\"width:100px\" type=\"number\" max=\"4094\" placeholder=\"VLAN\">"
		Options += "<label style=\"width:auto; margin-left:20px\" for=\"voipVpi\">VPI</label><input id=\"voipVpi\" name=\"voipVpi\" style=\"width:100px\" type=\"number\" max=\"255\" placeholder=\"VPI\">"
		Options += "<label style=\"width:auto; margin-left:20px\" for=\"voipVci\">VCI</label><input id=\"voipVci\" name=\"voipVci\" style=\"width:100px\" type=\"number\" max=\"65535\" placeholder=\"VCI\"></div>"
		Options += "<br><div class=\"pure-control-group\"><label>Vidéo</label></div>"
		Options += "<div class=\"pure-control-group\"><label for=\"videoVlan\">VLAN</label><input id=\"videoVlan\" name=\"videoVlan\" style=\"width:100px\" type=\"number\" max=\"4094\" placeholder=\"VLAN\">"
		Options += "<label style=\"width:auto; margin-left:20px\" for=\"videoVpi\">VPI</label><input id=\"videoVpi\" name=\"videoVpi\" style=\"width:100px\" type=\"number\" max=\"255\" placeholder=\"VPI\">"
		Options += "<label style=\"width:auto; margin-left:20px\" for=\"videoVci\">VCI</label><input id=\"videoVci\" name=\"videoVci\" style=\"width:100px\" type=\"number\" max=\"65535\" placeholder=\"VCI\"></div>"
